    ...
    return (
        <div>
            ...
            <input type="text" placeholder='what are you looking for' className='absolute top-32 w-[22rem] md:w-[76rem] md:top-28  p-3 rounded-3xl' />
                ...
                <div className='absolute top-[13rem] md:top-[20rem]'>
                    <h2 className='font-bold text-2xl md:text-6xl text-white'>Tunis</h2>
                    <br className='hidden md:block'/>
                    <h1 className='font-bold text-3xl md:text-7xl text-white'>Safarie</h1>
                </div>
            </div>
        </div>
    )
